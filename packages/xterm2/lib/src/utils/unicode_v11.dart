...
// Width and combining ranges synchronized with Unicode 17.0 through the
// unicode-width 0.2.2 data used by Alacritty, retaining Ghostty-compatible
// zero-width format controls. Historical API names remain for compatibility.
const BMP_COMBINING = [
  [0x00AD, 0x00AD],
  [0x0300, 0x036F],
  [0x0483, 0x0489],
